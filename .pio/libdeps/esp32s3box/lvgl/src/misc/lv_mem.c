...
//    static LV_ATTRIBUTE_LARGE_RAM_ARRAY MEM_UNIT work_mem_int[LV_MEM_SIZE / sizeof(MEM_UNIT)];
    __attribute__((aligned(4))) LV_ATTRIBUTE_LARGE_RAM_ARRAY MEM_UNIT *work_mem_int =
            (MEM_UNIT *)heap_caps_malloc(LV_MEM_SIZE / sizeof(MEM_UNIT),MALLOC_CAP_DMA | MALLOC_CAP_INTERNAL);
